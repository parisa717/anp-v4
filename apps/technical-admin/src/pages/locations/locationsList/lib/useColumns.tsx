import { DataTableDropdown, DataTableMultiSelect, DataTableSearchInput, EntityStatusDropdown } from '@nexus-ui/ui'
...
export const useColumns = () => {
  ...
  const columns: ColumnProps[] = [
    ...
    },
    {
      ...
      header: 'Status',
      body: (location: LocationEntity) => <EntityStatusDropdown value={location.isActive} onChange={() => {}} />,
      sortable: true,
      filter: true,
