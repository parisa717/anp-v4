import {
  GqlGetServiceAdvisorCalendarCalendarEntryObjectType,
...
export type ServiceAdvisorCalendarEntry = Omit<GqlGetServiceAdvisorCalendarCalendarEntryObjectType, '__typename'>
