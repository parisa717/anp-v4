...
describe('WeekHeader', () => {
  ...
  it('shows label properly', () => {
    cy.mountWithProviders(<WeekHeader label={labelText} date={new Date()} workDays={[]} localizer={localizer} />)
  ...
  it('show work day time when date is work day', () => {
    ...
    cy.mountWithProviders(<WeekHeader label={labelText} date={date} workDays={workDays} localizer={localizer} />)
